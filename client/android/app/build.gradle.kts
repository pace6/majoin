...
// Release signing — load android/key.properties if present (CI writes it
// from secrets; see docs/app-distribution.md). Absent locally → debug signing.
...
android {
    ...
    defaultConfig {
        applicationId = "app.majoin.majoin"
